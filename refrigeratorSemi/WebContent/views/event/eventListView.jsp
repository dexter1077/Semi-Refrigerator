...
<body>
    ...
    <div class="outer" style="border: 1px solid black;">
        ...
        <div class="select-event" style="width: 500px;" align="right">
            <a href="<%=contextPath%>/list.event?currentPage=1" style="color:rgb(0, 153, 102);">진행중인 이벤트</a> &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
            <a href="<%=contextPath%>/endlist.event?currentPage=1" style="color:rgba(190, 190, 190, 0.5);">종료된 이벤트</a>
        </div>
        ...
        <!--페이징바   -->
               ...
               <div class="paging-area" align="center">
                    ...
                    <% if(currentPage != 1) { %>
                    <button onclick="location.href='<%=contextPath%>/list.event?currentPage=<%=currentPage-1%>';">&lt;</button>
                    <% } %>
                    
                    <% for(int p=startPage; p<=endPage;p++) {%>
                
                        <% if(p != currentPage) {%>
                        <button onclick="location.href='<%=contextPath%>/list.event?currentPage=<%=p%>';"><%=p%></button>
                        <%} else { %>
