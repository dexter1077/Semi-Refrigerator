...
/**
 * Servlet implementation class UserSelectEventViewController
 */
@WebServlet("/list.event")
public class UserSelectEventViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserSelectEventViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<AdmEvent>list = new EventService().userSelectEventList(pi);
