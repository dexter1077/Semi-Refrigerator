...
/**
 * Servlet implementation class MainRecipeSortViewController
 */
@WebServlet("/recipeView.main")
public class MainRecipeSortViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainRecipeSortViewController() {
        super();
