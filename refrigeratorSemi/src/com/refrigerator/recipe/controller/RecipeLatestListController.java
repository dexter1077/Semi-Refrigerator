...
/**
 * @author leeyeji
 * Servlet implementation class RecipeLatestListController
 */
@WebServlet("/latestList.recipe")
public class RecipeLatestListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecipeLatestListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Recipe> pageList = new RecipeService().selectLatestRecipeList(pi);
